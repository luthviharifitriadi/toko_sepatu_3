...
import 'package:toko_sepatu_3/pages/detail_chat_page.dart';
                  ...
                  GestureDetector(
                    ...
                    child: Image.asset(
                      wishlistProvider.isWishlist(widget.product)
                          ? 'assets/Button_Whishlist_Blue.png'
                          : 'assets/Button_Whishlist.png',
                      width: 46,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetaiChatPage(widget.product),
                        ),
                      );
                    },
                    child: Container(
